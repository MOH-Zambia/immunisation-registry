...
class ImportUpdatedDHIS2ClientData extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:ImportUpdatedDHIS2ClientData';
    ...
    public function loadEvents($startDate, $endDate): array
    {
        ...
        foreach($facilities as $facility) {
            ...
            if(!empty($facility->DHIS2_UID)) {
                ...
                $this->getOutput()->writeln("$time <error>Facility with DHIS2 UID: {$facility->DHIS2_UID}, NOT FOUND. UID is Invalid or Does Not Exist!</error>");
            }
    ...
    public function handle()
    {
        ...
        $this->info('command:ImportUpdatedDHIS2ClientData Command Run successfully!');
