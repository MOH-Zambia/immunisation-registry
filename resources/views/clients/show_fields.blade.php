...
<div class="col-sm-12">
    ...
    <p>{{ $client->contact_email_address }}</p>
</div>
...
<div class="col-sm-12">
    ...
    <p>{{ $client->next_of_kin_contact_number }}</p>
</div>
