            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="{{url('img/apple-icon-152x152.png')}}"
                         class="user-image img-circle elevation-2" alt="Zambia coat of arms">
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2020 <a href="https://www.moh.gov.zm">Ministry of Health</a>.</strong> All rights
        reserved.
    </footer>
</div>
...
<!-- AdminLTE App -->
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/admin-lte/3.0.5/js/adminlte.min.js"
...
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-switch/3.3.4/js/bootstrap-switch.min.js" integrity="sha512-J+763o/bd3r9iW+gFEqTaeyi+uAphmzkE/zU8FxY6iAvD3nQKXa+ZAWkBI9QS9QkYEKddQoiy0I5GDxKf/ORBA==" crossorigin="anonymous"></script>
