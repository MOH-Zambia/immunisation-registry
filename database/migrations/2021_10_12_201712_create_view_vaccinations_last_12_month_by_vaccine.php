...
class CreateViewVaccinationsLast12MonthByVaccine extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        return
            "CREATE OR REPLACE VIEW `view_vaccinations_last_12_month_by_vaccine` AS
                SELECT
                ...
                GROUP BY DATE_FORMAT(dates.date, '%Y-%m'), vaccinations.vaccine_id
    ...
    {
        return
            'DROP VIEW IF EXISTS `view_vaccinations_last_12_month_by_vaccine`';
    }
}
